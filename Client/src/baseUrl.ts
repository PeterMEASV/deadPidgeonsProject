...
import { AuthClient, BalanceClient, BoardClient, GameClient, UserClient, HistoryClient } from "./generated-ts-client.ts";
...
export const historyClient = new HistoryClient(finalUrl, { fetch: customFetch })
